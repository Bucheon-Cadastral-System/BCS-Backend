...
class SurveyJpaEntityTest {
    ...
    void recordRoundTrip_preservesAttributes() {
        ...
        SurveyRecord origin = SurveyRecord.restore(1L, 10L, SurveyResult.LOST, surveyedAt, "대상(2건)", 9L);
    ...
    void recordRoundTrip_withoutNote_keepsNull() {
        SurveyRecord origin = SurveyRecord.restore(
                1L, 10L, SurveyResult.INTACT, OffsetDateTime.parse("2025-09-08T10:00:00+09:00"), null, null);
