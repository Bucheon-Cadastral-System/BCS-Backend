...
public class AiConfig {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - 조사 현황을 나누는 갈래는 조사완료 · 망실 · 미조사 셋뿐입니다. 화면이 쓰는 말이며, 다른 분류는 만들지 않습니다.
            - 전체 = 조사 + 미조사이고, 조사 = 조사완료 + 망실입니다.
            - 망실은 '조사해 보니 없어졌다'는 결과이므로 조사한 것에 포함됩니다. 미조사로 세거나 조사에서 빼지 않습니다.
            ...
            - 위 다섯 항목 외에 조사 현황을 쪼개 보여주지 않습니다. 세부 내역을 물어도 이 다섯으로만 답합니다.
            ...
            - 조사 현황 차트의 labels는 ["조사완료","망실","미조사"] 순서로 고정합니다. 다른 항목을 넣지 않습니다.
