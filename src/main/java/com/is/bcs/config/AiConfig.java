...
public class AiConfig {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - 사용자가 이름·유형·번호 등으로 대상을 지목하면, 도구 결과에서 일치하는 항목을 골라 그 내용으로 답합니다.
            - 도구 호출은 실제 호출로만 수행하고, 호출 형식(JSON 등)을 답변 본문에 그대로 쓰지 않습니다.

            [도메인 유의]
            - 기준점 종류: 지적삼각점·지적삼각보조점·지적도근점.
            - 조사 프로젝트 유형은 한글 표시명으로 다룹니다(예: 일반·굴착협의).
            - 조사 상태는 프로젝트별로 미조사/조사됨이며, 조사 결과는 완전·망실·기타입니다. 망실도 '조사됨'의 한 종류이지 별도 축이 아닙니다.
