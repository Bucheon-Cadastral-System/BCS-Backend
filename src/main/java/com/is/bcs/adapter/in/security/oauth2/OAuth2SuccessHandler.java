...
//
//    public OAuth2SuccessHandler(@Value("${app.frontend-base-url}") String frontendBaseUrl) {
...
//    }
//
//    private void handleActive(HttpServletResponse response) throws IOException {
