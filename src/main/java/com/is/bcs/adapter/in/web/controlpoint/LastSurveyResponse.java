...
public record LastSurveyResponse(String result, LocalDate surveyedOn, String surveyorName) {

    public static LastSurveyResponse from(LastSurveySummary summary) {
        return new LastSurveyResponse(summary.result(), summary.surveyedOn(), summary.surveyorName());
    }
}
